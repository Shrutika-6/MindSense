...
export default function Home() {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-6 py-6 flex flex-col gap-6 relative select-none">
      ...
      <div className="absolute top-10 left-[15%] w-24 h-24 rounded-full bg-gradient-to-tr from-pink-300/30 to-purple-400/20 blur-md animate-pulse pointer-events-none" />
      <div className="absolute bottom-10 right-[15%] w-32 h-32 rounded-full bg-gradient-to-br from-mint-300/20 to-violet-400/20 blur-lg animate-bounce pointer-events-none" />
      <div className="absolute top-[40%] right-[30%] text-pink-300/40 text-xl animate-pulse">✦</div>

      {/* Top Welcome Banner */}
      <div className="w-full bg-white/60 backdrop-blur-xl border border-white/80 rounded-[28px] p-6 flex justify-between items-center shadow-[0_15px_35px_rgba(139,92,246,0.06)] relative overflow-hidden group">
        ...
        <div className="hidden md:block bg-gradient-to-r from-violet-500 to-pink-500 text-white font-extrabold text-xs px-4 py-2 rounded-xl shadow-md">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="md:col-span-5 bg-white/60 backdrop-blur-xl border border-white/80 rounded-[32px] p-8 shadow-[0_20px_50px_rgba(139,92,246,0.08)] flex flex-col items-center justify-between text-center relative overflow-hidden min-h-[400px]">
          ...
          >
            <div className="w-40 h-40 rounded-full bg-white/90 flex flex-col items-center justify-center p-3 text-center shadow-inner relative overflow-hidden group">
              ...
              <span className="text-xs font-extrabold text-violet-600 tracking-wider uppercase">Scan Face</span>
          ...
          <button 
            onClick={() => navigate("/emotion-detection")}
            className="w-full py-3.5 rounded-2xl font-extrabold text-white text-xs tracking-wider uppercase bg-gradient-to-r from-violet-500 via-pink-500 to-amber-400 shadow-[0_8px_20px_rgba(139,92,246,0.25)] hover:shadow-[0_12px_28px_rgba(139,92,246,0.35)] transition-all"
          >
            Start scanning
          </button>
        </div>
        ...
        <div className="md:col-span-7 flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div 
              onClick={() => navigate("/insights")}
              className="bg-white/60 backdrop-blur-xl border border-white/80 rounded-[28px] p-6 shadow-sm flex flex-col justify-between h-48 cursor-pointer hover:-translate-y-1.5 hover:shadow-[0_15px_30px_rgba(244,63,94,0.12)] transition-all group"
            >
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-pink-100 to-orange-200/50 flex items-center justify-center text-2xl shadow-inner group-hover:scale-105 transition-transform">
                📓
              </div>
              <div>
            ...
            <div 
              ...
              className="bg-white/60 backdrop-blur-xl border border-white/80 rounded-[28px] p-6 shadow-sm flex flex-col justify-between h-48 cursor-pointer hover:-translate-y-1.5 hover:shadow-[0_15px_30px_rgba(139,92,246,0.12)] transition-all group"
            >
            ...
            {/* Feature 4: Safe Crisis Support */}
            <div 
              onClick={() => navigate("/insights")}
              className="bg-white/60 backdrop-blur-xl border border-white/80 rounded-[28px] p-6 shadow-sm flex flex-col justify-between h-48 cursor-pointer hover:-translate-y-1.5 hover:shadow-[0_15px_30px_rgba(239,68,68,0.1)] transition-all group"
            >
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-rose-100 to-red-200/50 flex items-center justify-center text-2xl shadow-inner group-hover:scale-105 transition-transform">
                🆘
              </div>
              <div>
                <h4 className="text-base font-bold text-slate-800 leading-tight mb-1">Helplines & Safety</h4>
                <p className="text-slate-500 text-xs font-medium leading-relaxed">Immediate access to active helpline phone numbers and support systems.</p>
              </div>
            </div>
